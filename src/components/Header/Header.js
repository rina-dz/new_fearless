...
function Header(props) {
    ...
    //<input className='header__search-input' placeholder='Начни вводить название товара...' ref={inputRef} />
        ...
        <header className='header'>
            <div className='header__main-container'>
                ...
                <div className='header__functional-container'>
                    <form className='header__search' onFocus={focuseForm} ref={inputRef} onBlur={() => {props.changeSearchVisibility();}}>
